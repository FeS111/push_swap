...
# File Variables
NAME	= push_swap
SRC		= $(addprefix src/, push_swap.c ft_stack_util.c ft_stack_util2.c ft_stack_util3.c ft_swap.c ft_push.c ft_rotate.c ft_reverse_rotate.c sort.c is_sorted.c)
